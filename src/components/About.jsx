...
const BioContent = () => (
  <>
    ...
    <div className="space-y-6 text-clay text-lg font-light leading-relaxed">
      ...
      <p>
        I believe travel is for everyone. I proudly serve the LGBTQ+ community and the allies who champion it. I'm proud to specialize in Luxury and LGBTQ+ travel, ensuring every trip is planned with inclusivity, comfort, and celebration in mind. Whether you're traveling as a family, a couple, a group of friends, or on your own, your journey is always designed around you.
      </p>
      <p>
...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 lg:py-36 bg-ivory">
      ...
      <div className="hidden lg:block max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid lg:grid-cols-12 gap-20 items-center">
          ...
          >
            ...
            >
              ...
              <motion.div
                className="absolute -bottom-6 -left-6 bg-espresso text-white p-6"
              ...
              <motion.div
                className="absolute -bottom-6 -right-6 bg-white text-espresso p-4 shadow-sm border border-sand"
                initial={{ opacity: 0, scale: 0.8 }}
                whileInView={{ opacity: 1, scale: 1 }}
                viewport={{ once: true }}
