  ...
  return (
    <section className="py-24 lg:py-32 bg-sand/40">
      <div className="max-w-3xl mx-auto px-6 lg:px-12 text-center">
        ...
        >
          Bearings for your next journey
        </motion.h2>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          Quietly curated specials, timely advisories, and the news worth knowing
          before you book. No noise, just the good stuff. Unsubscribe anytime.
        </motion.p>
